...
#include <amerigo_msgs/GetPosition.h>
#include <amerigo_msgs/SetPosition.h>
...
bool getPresentPositionCallback(
  amerigo_msgs::GetPosition::Request & req,
  amerigo_msgs::GetPosition::Response & res)
{
  uint8_t dxl_error = 0;
...
void setPositionCallback(const amerigo_msgs::SetPosition::ConstPtr & msg)
{
  uint8_t dxl_error = 0;
  int dxl_comm_result = COMM_TX_FAIL;
